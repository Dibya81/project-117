...
export default function HomePage() {
  ...
  const satellites = useMemo<Satellite[]>(() => {
    ...
    return [
      { id: "simulation", label: "Simulation", descriptor: "Test Scenarios", detail: "The digital twin and the faults injected into it", href: "/console/simulation", count: jobs?.length ?? null, countLabel: "jobs", ring: 0, phase: 0.0, tone: "#3b82f6", icon: "graph" },
      { id: "operations", label: "Operations", descriptor: "Live Plant Overview", detail: "The running plant, area by area", href: "/console/equipment", count: equipment?.length ?? null, countLabel: "assets", ring: 1, phase: 0.79, tone: "#0ea5e9", icon: "equipment" },
      ...
      { id: "equipment", label: "Equipment", descriptor: "Monitors & Sensors", detail: "Assets and their instrumented points", href: "/console/equipment", count: sensorCount, countLabel: "points", ring: 0, phase: 1.57, tone: "#0891b2", icon: "gauge" },
