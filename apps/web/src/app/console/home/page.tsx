...
export default function HomePage() {
  ...
  const satellites = useMemo<Satellite[]>(() => {
    ...
    return [
      { id: "simulation", label: "Simulation", detail: "The digital twin and the faults injected into it", href: "/console/simulation", count: jobs?.length ?? null, countLabel: "jobs", ring: 0, phase: -0.2, tone: "#3b82f6" },
      { id: "operations", label: "Operations", detail: "Live plant overview and the equipment behind it", href: "/console/equipment", count: equipment?.length ?? null, countLabel: "assets", ring: 1, phase: 1.05, tone: "#0ea5e9" },
      { id: "documents", label: "Documents", detail: "Procedures and manuals behind every citation", href: "/console/documents", count: artifacts?.length ?? null, countLabel: "artifacts", ring: 1, phase: -2.2, tone: "#6366f1" },
      { id: "equipment", label: "Equipment", detail: "Assets and their instrumented points", href: "/console/equipment", count: sensorCount, countLabel: "points", ring: 0, phase: 2.35, tone: "#0891b2" },
      { id: "agents", label: "AI agents", detail: "The workforce that detects, decides and acts", href: "/console/workspace", count: agents?.length ?? null, countLabel: "agents", ring: 0, phase: 1.15, tone: "#7c3aed" },
      { id: "work-orders", label: "Work orders", detail: "Maintenance raised, and by whom", href: "/console/work-orders", count: openWOs.length, countLabel: "open", ring: 1, phase: 2.6, tone: "#f59e0b" },
      { id: "insights", label: "Insights", detail: "What the plant's numbers are saying", href: "/console/insights", count: null, countLabel: "analytics", ring: 0, phase: -1.25, tone: "#2563eb" },
      { id: "history", label: "History", detail: "Operational memory — decided, acted, verified", href: "/console/history", count: null, countLabel: "memory", ring: 1, phase: -0.55, tone: "#64748b" },
      { id: "knowledge", label: "Knowledge graph", detail: "Equipment, documents and events as one topology", href: "/console/knowledge", count: null, countLabel: "graph", ring: 0, phase: 3.4, tone: "#8b5cf6" },
    ];
